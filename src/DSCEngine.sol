...
contract DSCEngine is ReentrancyGuard {
     ...
     * @param amountDscToMint The amount of decentralized stable to mint
    ...
    /**
     * @param tokenCollaterlAddress The collateral address to redeem
     * @param amountColleteral The amount of collateral to redeem
     * @param amountDscToBurn The amount of DSC to burn
     * This function burns DSC and redeems underlying collateral in one transaction
     */
    function redeemCollateralForDsc(address tokenCollaterlAddress, uint256 amountColleteral, uint256 amountDscToBurn)
        external
    {
        burnDsc(amountDscToBurn);
        redeemCollateral(tokenCollaterlAddress, amountColleteral);
    }
        ...
        nonReentrant
    {
        ...
        uint256 tokenAmountFromDebtCoverted = getTokenAmountFromUsd(collateral, debtToCover);
    }
    ...
    function _healthFactor(address user) private view returns (uint256) {
        ...
        // $150 * 50 = 7500 / 100 = (75 / 100) < 1 ---> get liquidated

        // $750 * 50 = 37500 / 100 = 375 / 100 > 1 ---> not liquidated
